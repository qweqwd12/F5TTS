...
def load_f5tts():
    ckpt_path = "/root/autodl-tmp/F5-TTS/ckpts/F5TTS_Base_vocos_pinyin_losl_2/model_1000.pt"
...
with gr.Blocks() as app_tts:
    ...
    gen_text_input = gr.Textbox(label="生成文字", lines=10)
    ...
    audio_output = gr.Audio(label="生成合成音频")
