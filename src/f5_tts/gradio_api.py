...
DEFAULT_TTS_MODEL_CFG = [
    ...
    "/root/autodl-tmp/F5-TTS/data/losl/vocab.txt",
...
def load_f5tts():
    ...
    return load_model(DiT, F5TTS_model_cfg, ckpt_path)#, vocab_file="/root/autodl-tmp/F5-TTS/data/Emilia_ZH_EN_pinyin/vocab.txt"
...
"""
    ...
    with gr.Row():
        ...
        # else:
        #     choose_tts_model = gr.Radio(
        #         choices=["E2-TTS"], label="Choose TTS Model"
        #     )
