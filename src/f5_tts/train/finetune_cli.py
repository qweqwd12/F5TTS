...
def parse_args():
    ...
    parser.add_argument("--dataset_name", type=str, default="losl", help="Name of the dataset to use")
    parser.add_argument("--learning_rate", type=float, default=3e-5, help="Learning rate for training")
    parser.add_argument("--batch_size_per_gpu", type=int, default=4536, help="Batch size per GPU")
    parser.add_argument(
    ...
    parser.add_argument("--num_warmup_updates", type=int, default=2500, help="Warmup updates")
    ...
    parser.add_argument("--pretrain", type=str, default="/root/autodl-tmp/F5-TTS/ckpts/F5TTS_Base_vocos_pinyin_losl/model_1200000.safetensors", help="the path to the checkpoint")
    parser.add_argument(
...
def main():
    ...
    checkpoint_path = str("/root/autodl-tmp/F5-TTS/ckpts/E2TTS_Base_vocos_pinyin_losl")
